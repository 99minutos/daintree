  ...
  <div class="container">
    <section class="gl-banner">
      ...
      <div class="gl-banner-content">
        ...
        <p>
          Daintree will authenticate through your OAuth provider, and then will
          exchange the OAuth token it receives from the provider with AWS
        ...
        <p>
          ...
          subdomain just for you, with the configuration data already hardcoded,
          please write to
        ...
        <p>
          Since Daintree uses the implicit grant flow (given there is no backend
          in the app) the OAuth client needs to do not have any client secret to
          work.
        </p>

        <p>
          After you created your OAuth client, you can login in Daintree. You
          need to specify your OAuth client ID and the URL for the login to you
          OAuth provider during the login.
        </p>
